...
<body>
    <div class="container mt-3">
        ...
        <h1 class="py-3">Edit Data Service</h1>
...
Mahasiswa" value="{{ $mahasiswa->nama }}">
                ...
                <div class="form-group mb-3">
                    ...
                    <input name="nim" type="date" class="form-control mt-2" id="exampleInputEmail1" aria-describedby="EmailHelp" placeholder="Nomor Induk
Mahasiswa" value="{{ $mahasiswa->nim }}">
                </div>

                <div class="form-group mb-3">
                    <label for="exampleFormControlTextarea1">Keterangan Service</label>
                    <textarea name="alamat" class="form-control mt-2" id="exampleFormControlTextarea1" rows="3" placeholder="Alamat Mahasiswa">{{ $mahasiswa->alamat
}}</textarea>
                </div>

                <div class="form-group mt-5">
                    <button type="submit" class="btn btn-success">Update</button>
                    <a href="/mahasiswa" class="btn btn-danger mx-
3">Cancel</a>
